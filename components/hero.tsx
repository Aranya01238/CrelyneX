...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-background pt-18 pb-10 sm:pt-24 sm:pb-14">
      ...
      <div className="container mx-auto px-4">
        <div className="grid items-center gap-6 sm:gap-10 lg:min-h-[calc(100vh-110px)] lg:gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="order-1 mx-auto flex w-full max-w-[22rem] flex-col items-center space-y-5 text-center sm:max-w-none sm:space-y-8 lg:order-1 lg:items-start lg:px-0 lg:text-left">
            <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-accent/40 bg-accent/10 px-3 py-1.5 text-[10px] font-semibold tracking-[0.16em] text-accent sm:px-4 sm:text-xs">
              INTERACTIVE 3D EXPERIENCE
            </div>

            <div className="space-y-3 sm:space-y-4">
              <h1 className="max-w-[11ch] text-[2.35rem] font-black leading-[0.92] tracking-tight [text-wrap:balance] sm:max-w-none sm:text-5xl md:text-6xl xl:text-7xl">
              ...
              <p className="mx-auto max-w-[20rem] text-sm leading-7 text-muted-foreground sm:max-w-xl sm:text-lg lg:mx-0 lg:max-w-xl">
            ...
            <div className="flex w-full flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <Button
                asChild
                size="lg"
                className="min-h-12 w-full max-w-[20rem] rounded-2xl bg-accent px-6 text-base font-bold text-accent-foreground shadow-lg shadow-accent/30 hover:bg-accent/90 sm:min-h-0 sm:w-auto sm:max-w-none sm:px-8"
              >
                <Link href="/about">Start Learning</Link>
              </Button>
            </div>

            <div className="grid w-full grid-cols-3 gap-2 sm:max-w-lg sm:gap-3 lg:max-w-xl">
