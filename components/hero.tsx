...
export default function Hero() {
  return (
    <section className="relative overflow-x-clip overflow-y-hidden bg-background pt-20 pb-10 sm:pt-24 sm:pb-14">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid grid-cols-1 items-center gap-6 sm:gap-10 lg:min-h-[calc(100vh-110px)] lg:gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="order-1 min-w-0 w-full space-y-5 text-left sm:space-y-8 lg:order-1 lg:px-0">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 className="max-w-[10.5ch] text-[1.95rem] font-black leading-[0.95] tracking-tight [text-wrap:balance] sm:max-w-none sm:text-5xl md:text-6xl xl:text-7xl">
              ...
              <p className="max-w-[21rem] text-base leading-7 text-muted-foreground sm:max-w-xl sm:text-lg lg:max-w-xl">
            ...
            <div className="flex w-full flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <Button
                asChild
                size="lg"
                className="min-h-12 w-full max-w-full rounded-2xl bg-accent px-6 text-base font-bold text-accent-foreground shadow-lg shadow-accent/30 hover:bg-accent/90 sm:min-h-0 sm:w-auto sm:max-w-none sm:px-8"
              >
                <Link href="/about">Start Learning</Link>
              </Button>
            </div>

            <div className="grid w-full grid-cols-1 gap-2 sm:max-w-lg sm:grid-cols-3 sm:gap-3 lg:max-w-xl">
              ...
              <div className="rounded-2xl border border-border/50 bg-card/50 p-2.5 backdrop-blur sm:col-span-1 sm:p-4">
          ...
          {/* 3D Brand Scene */}
          <div className="order-2 min-w-0 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative h-[136px] w-full max-w-full overflow-hidden rounded-[1.75rem] border border-border/60 bg-gradient-to-br from-card/80 to-card/40 shadow-[0_20px_80px_-35px_oklch(0.62_0.22_185)] sm:h-[260px] sm:max-w-2xl lg:h-[380px]">
              <ThreeHeroScene />
