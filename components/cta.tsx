...
export default function CTA() {
  return (
    <section id="community" className="relative py-20 px-4 bg-background overflow-hidden">
      {/* Animated background */}
      ...
      <div className="container mx-auto max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Service Tracks</div>
              </div>
              <div className="text-center">
          ...
          <div className="relative h-full min-h-96 flex items-center justify-center">
            <Card className="relative w-full max-w-sm p-8 bg-card border-border/40 shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold text-foreground">CrelyneX</h3>
                ...
                <div className="space-y-3 py-6 border-y border-border/40">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm font-semibold text-foreground">Active Daily</div>
                      <div className="text-xs text-muted-foreground">Real-time discussions</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Project collaborations</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Learning materials</div>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-center text-xs text-muted-foreground">
                  In Association with <span className="font-semibold text-accent">Hind Svaasth Seva</span> & <span className="font-semibold text-secondary">AI ZENERA</span>
                </p>
              </div>
