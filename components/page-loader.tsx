  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-red-950/20 blur-[120px] animate-pulse" />
        <div className="absolute bottom-0 left-1/4 w-64 h-64 rounded-full bg-red-900/10 blur-[80px] animate-pulse" style={{ animationDelay: "1s" }} />
        {/* Grid */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        {/* Logo */}
        <div
          className="relative flex items-center justify-center w-24 h-24 rounded-3xl border border-red-500/20 bg-black/60 shadow-[0_0_60px_rgba(220,38,38,0.3)]"
          style={{ animation: "loader-logo 0.6s cubic-bezier(.22,1,.36,1) both" }}
        >
          {/* Spinning ring */}
          <div
            className="absolute inset-[-8px] rounded-[28px] border-2 border-transparent border-t-red-600/80 animate-spin"
            style={{ animationDuration: "1.5s" }}
          />
          <Image src="/logo.png" alt="CrelyneX" width={52} height={52} className="object-contain drop-shadow-[0_0_12px_rgba(220,38,38,0.8)]" />
        </div>

        {/* Brand name */}
        <div className="text-center" style={{ animation: "fadeInUp 0.6s 0.3s cubic-bezier(.22,1,.36,1) both" }}>
          <div className="text-3xl font-black tracking-widest text-gradient-crimson mb-1">CrelyneX</div>
        ...
        >
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs text-red-500 font-mono font-bold">{progress}%</span>
          </div>
          <div className="h-0.5 w-full rounded-full bg-white/5 overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-red-700 via-red-500 to-red-400 rounded-full shadow-[0_0_8px_rgba(220,38,38,0.8)] transition-all duration-100 ease-out"
